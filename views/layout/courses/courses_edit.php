...
<body>
    ...
    <div class="page-container">
        <div class="form-card">
           <form action="index.php?page=courses&action=edit&id=<?= $_GET['id'] ?>" 
      method="POST" 
      enctype="multipart/form-data">
    <label>Course Title</label>
    <input type="text" name="titre" value="<?= $data['title'] ?>" required>
    <label>Description</label>
    <textarea name="desc" required><?= $data['DescriptionC'] ?></textarea>
